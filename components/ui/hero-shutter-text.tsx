...
export default function HeroText({
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-6 flex flex-col items-center gap-4 z-20">
        <motion.button
      ...
      {/* Corner Accents */}
      <div className="absolute top-4 left-4 border-l border-t border-zinc-800 w-8 h-8" />
      <div className="absolute bottom-4 right-4 border-r border-b border-zinc-800 w-8 h-8" />
    </div>
  );
}
